        ...
        >
            {!isAuthenticated ? (
                ...
                <>
                    <Stack.Screen 
                        name="Login" 
                        component={getScreenComponent('Login') || LoginScreen} 
                    />
                ...
                <>
                    {isSmartwatch ? (
                        ...
                        <Stack.Screen 
                            name="SmartWatchHome" 
                            component={SmartWatchHomeScreen} 
                        />
                        ...
                        <>
                            <Stack.Screen 
                                name="Dashboard" 
                                component={DashboardScreenPC} 
                            />
                            <Stack.Screen 
                                name="MessageManagement" 
                                component={MessageManagementPC} 
                            />
                            <Stack.Screen 
                            ...
                            <Stack.Screen 
                                ...
                                component={MessageAssignmentScreen} 
                            />
